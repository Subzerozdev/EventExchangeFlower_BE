...
public class TransactionServiceImpl implements TransactionService {
    ...
    public void createTransactions(Order order) {
        ...
        float newBalance = admin.getBalance() + order.getTotalMoney() * 0.2f;
        transactions02.setAmount(order.getTotalMoney() * 0.2f);
        ...
        transaction03.setAmount(order.getTotalMoney() * 0.8f);
